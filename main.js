...
/* ---------------------------------------------------------------------
   ...
   ⚠️ 지금은 이메일 주소가 그대로 적혀 있습니다. 이 파일은 누구나 볼 수
      있어서 스팸 수집 프로그램이 이 주소를 긁어갈 수 있습니다.
      첫 신청 뒤 오는 확인 메일에 암호로 된 주소가 함께 옵니다
      (formsubmit.co/xxxxxxxx 꼴). 그것으로 바꾸면 받는 곳은 그대로인
      채 이메일만 드러나지 않습니다. ★ 확인 메일을 누르신 뒤 그 주소를
      알려주시면 이 줄을 바꿔 드립니다.
--------------------------------------------------------------------- */
const FORM_ENDPOINT = "https://formsubmit.co/cheerleader.sue@gmail.com";
